      ...
      <section className="relative w-full bg-gradient-to-r from-green-50 to-green-100 py-20 px-6 md:px-12 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12">
          <div className="md:w-1/2 relative group cursor-pointer">
            ...
            />
            <div className="absolute bottom-4 left-4 bg-green-700 text-white px-4 py-2 rounded-lg shadow-lg text-sm font-semibold">
              Plant of the Week
            </div>
          </div>
          ...
          <div className="md:w-1/2 flex flex-col gap-6">
            ...
            <button className="mt-4 px-6 py-3 bg-gradient-to-r from-green-500 to-green-700 text-white font-bold rounded-xl shadow-lg hover:from-green-600 hover:to-green-800 transition-all duration-300 w-max">
              Learn More
            </button>
          </div>
        </div>
